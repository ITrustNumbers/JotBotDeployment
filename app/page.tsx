...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col text-[#f3c629]">
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#6A1B9A] via-[#febad2] via-50% to-[#0D47A1]"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,#6A1B9A_20%,transparent_40%)] opacity-80"></div>
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        <header className="container mx-auto px-4 py-6 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-[#f3c629]">JotBot</span>
          </div>
          <nav>
            <Link href="/dashboard" className="bg-gradient-to-r from-[#6A1B9A] to-[#0D47A1] hover:from-[#FFF6B3] hover:to-[#F6C794] text-[#f3c629] hover:text-[#6A1B9A] shadow-lg font-bold py-4 px-6 rounded-full transition duration-300">
              Try It Now
            </Link>
          </nav>
        </header>
        ...
        <main className="container mx-auto px-4 flex-grow">
          ...
          <section className="py-20 text-center">
            <motion.h1
              className="text-5xl md:text-6xl font-bold mb-6 text-[#f3c629]"
              initial="hidden"
            ...
            <motion.p
              className="pt-2 text-xl md:text-2xl mb-12 text-[#f3c629]"
              initial="hidden"
              animate={isVisible ? "visible" : "hidden"}
              variants={fadeIn}
            ...
            >
              <Link href="/dashboard" className="text-2xl bg-gradient-to-r from-[#6A1B9A] to-[#0D47A1] hover:from-[#FFF6B3] hover:to-[#F6C794] text-[#f3c629] hover:text-[#6A1B9A] shadow-lg font-bold py-6 px-12 rounded-full transition duration-300">
                Get Started
              </Link>
            </motion.div>
          </section>
          ...
          <section className="py-12">
            <h2 className="text-4xl font-bold mb-12 text-center text-[#621d7f]"
            // style={{ WebkitTextStroke: "0.5px black", color: "#29b959" }}
            >How It Works</h2>
            <div className="grid md:grid-cols-3 gap-8 text-[#f3c629] hover:text-[#6A1B9A] transition duration-300">
              {[
                ...
                <motion.div
                  key={index}
                  className="bg-gradient-to-br from-[#6A1B9A] to-[#0D47A1] hover:from-[#FFF6B3] hover:to-[#F6C794] p-6 rounded-lg text-center shadow-lg hover:shadow-xl transition-shadow duration-300"
                  initial="hidden"
                  animate={isVisible ? "visible" : "hidden"}
                  variants={fadeIn}
          ...
          <section className="py-20">
            <h2 className="text-4xl font-bold mb-12 text-center text-[#621d7f]">Benefits</h2>
            <div className="grid md:grid-cols-2 gap-8 text-center text-[#f3c629] hover:text-[#6A1B9A] transition duration-300">
              {[
        ...
        <footer className="bg-transparent py-4 mt-20">
          <div className="container mx-auto px-4 text-center text-xl text-[#FFFFFF]">
