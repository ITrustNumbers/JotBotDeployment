      ...
      sections: [
        {
          ...
          children: [
            ...
            ...formatSection('Insights', meeting.insights.map((insight: { insight: any }) => `${insight.insight}`)),
            ...
            ...formatSection('Attendees', meeting.attendees.map((attendee: { name: any}) => `${attendee.name}`)),
            ...formatSection('Follow-ups', meeting.followUps.map((followUp: { description: any; owner: any }) => `**Follow-up:** ${followUp.description}\n**Owner:** ${followUp.owner}`)),
            ...formatSection('Risks', meeting.risks.map((risk: { risk: any}) => `**Risk:** ${risk.risk}`)),
