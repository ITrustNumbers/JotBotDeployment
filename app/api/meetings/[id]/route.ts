  ...
  try {
    ...
    const formattedMeeting = {
      ...
      breakdown: {
        ...
        Insights: meeting.insights.map((insight: { insight: any}) => ({ insight: insight.insight})),
        ...
        Attendees: meeting.attendees.map((attendee: { name: any}) => ({ name: attendee.name})),
        ...
        Risks: meeting.risks.map((risk: { risk: any}) => ({ risk: risk.risk})),
